...
// src/components/WorkerChartJobs.jsx
...
export default function WorkerChartJobs() {
  const { chartData, loadChart, loading, error, workers } = useWorkers();
  ...
  // refresh chart whenever workers data changes (e.g., edit role, create/delete)
  useEffect(() => {
    loadChart();
  }, [workers, loadChart]);
